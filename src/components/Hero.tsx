...
const Hero = ({ mainData }: HeroProps) => {
    ...
    return (
        <section id='home' className={`relative min-h-screen w-full mx-auto overflow-hidden shadow-sm`}>
            ...
            <div className="py-16 lg:py-48 flex flex-col-reverse lg:flex-row justify-around gap-10 lg:gap-0">
                ...
                <div className="flex flex-col gap-4 md:gap-6 text-left lg:w-1/4 2xl:w-1/3 mx-4 md:mx-6 xl:mx-0">
                    <p className="text-xl md:text-5xl font-bold relative text-black">
                        {name}
                    </p>
                    <div className="flex flex-row items-start md:items-center gap-1.5">
                        <h2 className="text-lg md:text-2xl text-black">
                            We Provide
                        </h2>
                        <Typewriter
                            options={{
                ...
                <div className="relative mx-auto lg:mx-0 mt-12 md:mt-16 lg:mt-0">
                    <div className="w-full md:h-80 lg:-translate-x-16">
                        <img alt='avatar' className="w-full h-full object-cover" src="/hero-dark.png" />
                    </div>
