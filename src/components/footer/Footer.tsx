...
const Footer = () => {
    return (
        <div className='mt-20'>
            <section className="relative py-20 bg-[#fcfaff] w-full">
                <div className="max-w-screen-xl container mx-auto px-4">
                    <div className="">
                        <div className="pb-10 mb-10 items-center">
                        ...
                        <div className="flex flex-wrap -mx-4 mb-18">
                            <div className="w-full lg:w-2/5 px-4 mb-12 lg:mb-0">
                                <div className="xs:max-w-xs">
                                    ...
                                    <form action="">
                                        <label className="block mb-1.5 text-sm font-semibold text-white" >Email</label>
                                        <div className="xs:flex items-center">
                                            <div className="relative mb-4 xs:mb-0 xs:mr-4">
                                                ...
                                                <input className="w-full p-12 pr-4 py-4 text-sm text-gray-300 placeholder-gray-400 rounded-lg bg-gray-800 border border-gray-700 outline-none" type="email" placeholder="pat@shuffle.dev" />
                                            </div>
